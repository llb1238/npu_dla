set moduleName infer_Pipeline_VITIS_LOOP_41_1
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_VITIS_LOOP_41_1}
...
set portList { 
	...
	{ gate_f_q0 sc_in sc_lv 32 signal 0 } 
	{ C_t_address0 sc_out sc_lv 7 signal 1 } 
	{ C_t_ce0 sc_out sc_logic 1 signal 1 } 
	{ C_t_q0 sc_in sc_lv 32 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U102", "Parent" : "0"},
...
set Spec2ImplPortList { 
	gate_f { ap_memory {  { gate_f_address0 mem_address 1 7 }  { gate_f_ce0 mem_ce 1 1 }  { gate_f_q0 mem_dout 0 32 } } }
