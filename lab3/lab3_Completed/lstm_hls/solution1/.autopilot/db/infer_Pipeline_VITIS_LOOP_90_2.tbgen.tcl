set moduleName infer_Pipeline_VITIS_LOOP_90_2
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_VITIS_LOOP_90_2}
...
dict set ap_memory_interface_dict vec_i { MEM_WIDTH 32 MEM_SIZE 624 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ empty int 10 regular  }
	{ input_r float 32 regular {array 784 { 1 3 } 1 1 }  }
	{ vec_i float 32 regular {array 156 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ vec_i_address0 sc_out sc_lv 8 signal 2 } 
	{ vec_i_ce0 sc_out sc_logic 1 signal 2 } 
	{ vec_i_we0 sc_out sc_logic 1 signal 2 } 
	{ vec_i_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
