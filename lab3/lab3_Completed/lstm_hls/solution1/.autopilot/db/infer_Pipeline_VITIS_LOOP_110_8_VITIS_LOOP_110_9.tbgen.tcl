set moduleName infer_Pipeline_VITIS_LOOP_110_8_VITIS_LOOP_110_9
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_VITIS_LOOP_110_8_VITIS_LOOP_110_9}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict vec_i { MEM_WIDTH 32 MEM_SIZE 624 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ vec_i float 32 regular {array 156 { 1 3 } 1 1 }  }
	{ vec_tmp float 32 regular {array 128 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "vec_i", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "vec_tmp", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ vec_tmp_address1 sc_out sc_lv 7 signal 1 } 
	{ vec_tmp_ce1 sc_out sc_logic 1 signal 1 } 
	{ vec_tmp_q1 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vec_tmp_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "vec_tmp", "role": "address1" }} , 
 	{ "name": "vec_tmp_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vec_tmp", "role": "ce1" }} , 
 	{ "name": "vec_tmp_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "vec_tmp", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_9ns_15_1_1_U47", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "119817", "Max" : "119817"}
	, {"Name" : "Interval", "Min" : "119817", "Max" : "119817"}
]}
...
set Spec2ImplPortList { 
	...
	vec_tmp { ap_memory {  { vec_tmp_address0 mem_address 1 7 }  { vec_tmp_ce0 mem_ce 1 1 }  { vec_tmp_we0 mem_we 1 1 }  { vec_tmp_d0 mem_din 1 32 }  { vec_tmp_address1 MemPortADDR2 1 7 }  { vec_tmp_ce1 MemPortCE2 1 1 }  { vec_tmp_q1 MemPortDOUT2 0 32 } } }
}
