set moduleName infer_Pipeline_VITIS_LOOP_41_19
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_VITIS_LOOP_41_19}
...
dict set ap_memory_interface_dict h_t { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set Spec2ImplPortList { 
	gate_o { ap_memory {  { gate_o_address0 mem_address 1 7 }  { gate_o_ce0 mem_ce 1 1 }  { gate_o_q0 mem_dout 0 32 } } }
