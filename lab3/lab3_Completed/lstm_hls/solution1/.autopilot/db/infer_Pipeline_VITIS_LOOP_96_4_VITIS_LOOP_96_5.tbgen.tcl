set moduleName infer_Pipeline_VITIS_LOOP_96_4_VITIS_LOOP_96_5
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_VITIS_LOOP_96_4_VITIS_LOOP_96_5}
...
dict set ap_memory_interface_dict gate_f { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ vec_i float 32 regular {array 156 { 1 3 } 1 1 }  }
	{ gate_f float 32 regular {array 128 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ gate_f_address1 sc_out sc_lv 7 signal 1 } 
	{ gate_f_ce1 sc_out sc_logic 1 signal 1 } 
	{ gate_f_q1 sc_in sc_lv 32 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_9ns_15_1_1_U18", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	gate_f { ap_memory {  { gate_f_address0 mem_address 1 7 }  { gate_f_ce0 mem_ce 1 1 }  { gate_f_we0 mem_we 1 1 }  { gate_f_d0 mem_din 1 32 }  { gate_f_address1 MemPortADDR2 1 7 }  { gate_f_ce1 MemPortCE2 1 1 }  { gate_f_q1 MemPortDOUT2 0 32 } } }
}
