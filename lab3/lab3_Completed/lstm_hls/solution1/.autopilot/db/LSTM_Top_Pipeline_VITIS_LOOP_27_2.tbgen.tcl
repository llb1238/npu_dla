set moduleName LSTM_Top_Pipeline_VITIS_LOOP_27_2
set isTopModule 0
...
set cdfgNum 42
set C_modelName {LSTM_Top_Pipeline_VITIS_LOOP_27_2}
...
set C_modelArgList {
	{ res float 32 regular {array 10 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "res", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	res { ap_memory {  { res_address0 mem_address 1 4 }  { res_ce0 mem_ce 1 1 }  { res_q0 mem_dout 0 32 } } }
	out_r { axis {  { out_r_TREADY out_acc 0 1 }  { out_r_TDATA out_data 1 96 }  { out_r_TVALID out_vld 1 1 } } }
}
