set moduleName infer_Pipeline_29
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_29}
...
dict set ap_memory_interface_dict C_t { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set portList { 
	...
	{ C_t_we0 sc_out sc_logic 1 signal 1 } 
	{ C_t_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
