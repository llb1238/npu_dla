set moduleName infer_Pipeline_VITIS_LOOP_34_17
set isTopModule 0
...
set cdfgNum 42
set C_modelName {infer_Pipeline_VITIS_LOOP_34_17}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict vec_tmp { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict stat_C { MEM_WIDTH 32 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ vec_tmp float 32 regular {array 128 { 1 3 } 1 1 }  }
	{ stat_C float 32 regular {array 128 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ stat_C_address1 sc_out sc_lv 7 signal 1 } 
	{ stat_C_ce1 sc_out sc_logic 1 signal 1 } 
	{ stat_C_q1 sc_in sc_lv 32 signal 1 } 
...
set Spec2ImplPortList { 
	...
	stat_C { ap_memory {  { stat_C_address0 mem_address 1 7 }  { stat_C_ce0 mem_ce 1 1 }  { stat_C_we0 mem_we 1 1 }  { stat_C_d0 mem_din 1 32 }  { stat_C_address1 MemPortADDR2 1 7 }  { stat_C_ce1 MemPortCE2 1 1 }  { stat_C_q1 MemPortDOUT2 0 32 } } }
}
