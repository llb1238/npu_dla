...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:LSTM_Top:2025.5\
...
proc create_root_design { parentCell } {
  ...
  set LSTM_Top_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:LSTM_Top:2025.5 LSTM_Top_0 ]
