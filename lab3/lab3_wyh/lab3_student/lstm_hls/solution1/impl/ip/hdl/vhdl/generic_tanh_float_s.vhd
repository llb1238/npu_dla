...
architecture behav of generic_tanh_float_s is 
    ...
    signal tmp_i_63_reg_389 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component LSTM_Top_faddfsubpcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component LSTM_Top_fcmp_32nsc4 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    LSTM_Top_faddfsubpcA_U32 : component LSTM_Top_faddfsubpcA
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    LSTM_Top_fmul_32nqcK_U33 : component LSTM_Top_fmul_32nqcK
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    LSTM_Top_fdiv_32nrcU_U34 : component LSTM_Top_fdiv_32nrcU
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    LSTM_Top_fptrunc_cud_U35 : component LSTM_Top_fptrunc_cud
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => tmp_i_63_reg_389,
        ce => ap_const_logic_1,
        dout => grp_fu_117_p1);

    LSTM_Top_fpext_32dEe_U36 : component LSTM_Top_fpext_32dEe
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    LSTM_Top_fcmp_32nsc4_U37 : component LSTM_Top_fcmp_32nsc4
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    LSTM_Top_dadd_64neOg_U38 : component LSTM_Top_dadd_64neOg
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state33)) then
                tmp_i_63_reg_389 <= grp_fu_129_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
