...
// ==============================================================
#ifndef __LSTM_Top_fpext_32dEe__HH__
#define __LSTM_Top_fpext_32dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fpext_32dEe) {
    ...
    SC_CTOR(LSTM_Top_fpext_32dEe):  ACMP_fpext_U ("ACMP_fpext_U") {
