...
// ==============================================================
#ifndef __LSTM_Top_mul_50nsncg__HH__
#define __LSTM_Top_mul_50nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_mul_50nsncg) {
    ...
    SC_CTOR(LSTM_Top_mul_50nsncg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
