...
// ==============================================================
#ifndef __LSTM_Top_mac_mulaocq__HH__
#define __LSTM_Top_mac_mulaocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_mac_mulaocq) {
    ...
    SC_CTOR(LSTM_Top_mac_mulaocq):  simcore_mac_0_U ("simcore_mac_0_U") {
