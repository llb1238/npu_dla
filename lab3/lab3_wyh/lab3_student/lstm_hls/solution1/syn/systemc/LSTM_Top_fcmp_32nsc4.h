...
// ==============================================================
#ifndef __LSTM_Top_fcmp_32nsc4__HH__
#define __LSTM_Top_fcmp_32nsc4__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fcmp_32nsc4) {
    ...
    SC_CTOR(LSTM_Top_fcmp_32nsc4):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
