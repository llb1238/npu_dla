...
// ==============================================================
#ifndef __LSTM_Top_mul_72nskbM__HH__
#define __LSTM_Top_mul_72nskbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_mul_72nskbM) {
    ...
    SC_CTOR(LSTM_Top_mul_72nskbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
