...
LSTM_Top::LSTM_Top(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_mnist_lstm_fu_76 = new mnist_lstm("grp_mnist_lstm_fu_76");
    grp_mnist_lstm_fu_76->ap_clk(ap_clk);
    grp_mnist_lstm_fu_76->ap_rst(ap_rst_n_inv);
    grp_mnist_lstm_fu_76->ap_start(grp_mnist_lstm_fu_76_ap_start);
    grp_mnist_lstm_fu_76->ap_done(grp_mnist_lstm_fu_76_ap_done);
    grp_mnist_lstm_fu_76->ap_idle(grp_mnist_lstm_fu_76_ap_idle);
    grp_mnist_lstm_fu_76->ap_ready(grp_mnist_lstm_fu_76_ap_ready);
    grp_mnist_lstm_fu_76->in_r_TDATA(in_r_TDATA_int);
    grp_mnist_lstm_fu_76->in_r_TVALID(in_r_TVALID_int);
    grp_mnist_lstm_fu_76->in_r_TREADY(grp_mnist_lstm_fu_76_in_r_TREADY);
    grp_mnist_lstm_fu_76->in_r_TKEEP(in_r_TKEEP_int);
    grp_mnist_lstm_fu_76->in_r_TSTRB(in_r_TSTRB_int);
    grp_mnist_lstm_fu_76->in_r_TUSER(in_r_TUSER_int);
    grp_mnist_lstm_fu_76->in_r_TLAST(in_r_TLAST_int);
    grp_mnist_lstm_fu_76->in_r_TID(in_r_TID_int);
    grp_mnist_lstm_fu_76->in_r_TDEST(in_r_TDEST_int);
    grp_mnist_lstm_fu_76->out_r_TDATA(grp_mnist_lstm_fu_76_out_r_TDATA);
    grp_mnist_lstm_fu_76->out_r_TVALID(grp_mnist_lstm_fu_76_out_r_TVALID);
    grp_mnist_lstm_fu_76->out_r_TREADY(grp_mnist_lstm_fu_76_out_r_TREADY);
    grp_mnist_lstm_fu_76->out_r_TKEEP(grp_mnist_lstm_fu_76_out_r_TKEEP);
    grp_mnist_lstm_fu_76->out_r_TSTRB(grp_mnist_lstm_fu_76_out_r_TSTRB);
    grp_mnist_lstm_fu_76->out_r_TUSER(grp_mnist_lstm_fu_76_out_r_TUSER);
    grp_mnist_lstm_fu_76->out_r_TLAST(grp_mnist_lstm_fu_76_out_r_TLAST);
    grp_mnist_lstm_fu_76->out_r_TID(grp_mnist_lstm_fu_76_out_r_TID);
    grp_mnist_lstm_fu_76->out_r_TDEST(grp_mnist_lstm_fu_76_out_r_TDEST);
    ...
    regslice_both_out_data_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TDATA);
    regslice_both_out_data_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    regslice_both_out_keep_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TKEEP);
    regslice_both_out_keep_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    regslice_both_out_strb_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TSTRB);
    regslice_both_out_strb_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    regslice_both_out_user_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TUSER);
    regslice_both_out_user_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    regslice_both_out_last_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TLAST);
    regslice_both_out_last_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    regslice_both_out_id_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TID);
    regslice_both_out_id_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    regslice_both_out_dest_V_U->data_in(grp_mnist_lstm_fu_76_out_r_TDEST);
    regslice_both_out_dest_V_U->vld_in(grp_mnist_lstm_fu_76_out_r_TVALID);
    ...
    SC_METHOD(thread_grp_mnist_lstm_fu_76_ap_start);
    sensitive << ( grp_mnist_lstm_fu_76_ap_start_reg );

    SC_METHOD(thread_grp_mnist_lstm_fu_76_out_r_TREADY);
    ...
    sensitive << ( grp_mnist_lstm_fu_76_in_r_TREADY );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    sensitive << ( grp_mnist_lstm_fu_76_ap_done );
    sensitive << ( ap_CS_fsm );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    grp_mnist_lstm_fu_76_ap_start_reg = SC_LOGIC_0;
    ap_CS_fsm = "0001";
    ...
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_ap_start, "grp_mnist_lstm_fu_76_ap_start");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_ap_done, "grp_mnist_lstm_fu_76_ap_done");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_ap_idle, "grp_mnist_lstm_fu_76_ap_idle");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_ap_ready, "grp_mnist_lstm_fu_76_ap_ready");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_in_r_TREADY, "grp_mnist_lstm_fu_76_in_r_TREADY");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TDATA, "grp_mnist_lstm_fu_76_out_r_TDATA");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TVALID, "grp_mnist_lstm_fu_76_out_r_TVALID");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TREADY, "grp_mnist_lstm_fu_76_out_r_TREADY");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TKEEP, "grp_mnist_lstm_fu_76_out_r_TKEEP");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TSTRB, "grp_mnist_lstm_fu_76_out_r_TSTRB");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TUSER, "grp_mnist_lstm_fu_76_out_r_TUSER");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TLAST, "grp_mnist_lstm_fu_76_out_r_TLAST");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TID, "grp_mnist_lstm_fu_76_out_r_TID");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_out_r_TDEST, "grp_mnist_lstm_fu_76_out_r_TDEST");
    sc_trace(mVcdFile, grp_mnist_lstm_fu_76_ap_start_reg, "grp_mnist_lstm_fu_76_ap_start_reg");
...
void LSTM_Top::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_mnist_lstm_fu_76_ap_ready.read())) {
            grp_mnist_lstm_fu_76_ap_start_reg = ap_const_logic_0;
        }
    }
}
...
void LSTM_Top::thread_grp_mnist_lstm_fu_76_ap_start() {
    grp_mnist_lstm_fu_76_ap_start = grp_mnist_lstm_fu_76_ap_start_reg.read();
}

void LSTM_Top::thread_grp_mnist_lstm_fu_76_out_r_TREADY() {
    grp_mnist_lstm_fu_76_out_r_TREADY = (ap_CS_fsm_state3.read() & out_r_TREADY_int.read());
}
...
void LSTM_Top::thread_in_r_TREADY_int() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in_r_TREADY_int = grp_mnist_lstm_fu_76_in_r_TREADY.read();
    } else {
...
void LSTM_Top::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(grp_mnist_lstm_fu_76_ap_done.read(), ap_const_logic_1))) {
